...
<html>
<head>  
    <title>Equida - Ajouter un lieu</title>
    <meta charset="utf-8"/>
...
%>
        ...
        <form action="ajouterLieu" method="POST">
            <div class="form-group" style="width: 400px;">
              <label for="exampleInputPassword1">Ville :</label><span class="erreur-formulaire"> ${pTabErreurs['nom']}</span>
              <input required type="text" class="form-control" id="exampleInputPassword1" placeholder="Précisez le nom de la ville" name="ville">
            </div>
            <div class="form-group" style="width: 400px;">
              <label for="exampleInputPassword1">Nombre de boxes :</label><span class="erreur-formulaire"> ${pTabErreurs['nbBoxes']}</span>
              <input required type="number" class="form-control" id="exampleInputPassword1" placeholder="Précisez le nombre de boxes" name="boxes">
            </div>
            <div class="form-group" style="width: 400px;">
              <label for="exampleInputPassword1">Commentaire :</label><span class="erreur-formulaire"> ${pTabErreurs['commentaire']}</span>
              <input required type="text" class="form-control" id="exampleInputPassword1" placeholder="Entrez un commentaire" name="commentaire">
            </div>
            <button type="submit" class="btn btn-primary">Ajouter ce lieu</button>
        </form></center>
    </body>
