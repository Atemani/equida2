...
%>
         ...
         <center><div style="width: 500px" class="alert alert-danger alert-dismissible fade show" role="alert">
            En supprimant définitivement cette race de cheval, vous supprimez également tout les chevaux et leur participations aux courses associées à celle-ci !
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
         </div></center>
         <center><br><h1>Supprimer la race "<% out.println(TypeCheval.getLibelle()); %>"</h1><br>
        
        <form action="supprimerTypesCheval" method="POST">
            ...
            <br><button type="submit" class="btn btn-primary">Supprimer la Race</button>
        </form></center>
    </body>
