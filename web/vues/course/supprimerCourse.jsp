...
%>
         ...
         <center><div style="width: 500px" class="alert alert-danger alert-dismissible fade show" role="alert">
            En supprimant définitivement cette course, vous supprimez également toutes les participations associées à celle-ci !
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
         </div></center>
         <center><br><h1>Supprimer la course"<% out.println(uneCourse.getLibelle()); %>" :</h1><br>
        
        <form action="supprimerCourse" method="POST">
            <input name="idCourse" type="hidden" value="<% out.println(uneCourse.getId()); %>"/>
            ...
            <br><button type="submit" class="btn btn-primary">Supprimer la course</button>
        </form></center>
    </body>
