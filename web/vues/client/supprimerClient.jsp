...
<html>
<head>  
    <title>Equida - Supprimer un client</title>
    <meta charset="utf-8"/>
...
%>
         ...
         <center><div style="width: 500px" class="alert alert-danger alert-dismissible fade show" role="alert">
            En supprimant définitivement ce client, vous supprimez également son compte associé, ses chevaux (et leur participations aux courses) mais également les interêts aux catégories de vente associées à celui-ci !
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
         </div></center>
         <center><br><h2>SUPPRIMER LE CLIENT <% out.println(client.getPrenom()+" "+client.getNom()); %> :</h2><br>
        ...
        <form action="supprimerClient" method="POST">
            ...
            <br><button type="submit" class="btn btn-primary">Supprimer le client</button>
        </form></center>
    </body>
