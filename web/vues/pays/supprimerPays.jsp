<%-- 
    Document   : supprimerPays
    Created on : 15 oct. 2019, 10:28:18
    Author     : MetzJulien
--%>
...
%>
         ...
         <center><div style="width: 500px" class="alert alert-danger alert-dismissible fade show" role="alert">
            En supprimant définitivement ce pays, vous supprimez également tout les clients associés à celui-ci !
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
         </div></center>
         <center><br><h2>SUPPRIMER LE PAYS <% out.println(pays.getNom()); %> :</h2><br>
        ...
        <form action="supprimerPays" method="POST">
            ...
            <br><button type="submit" class="btn btn-primary">Supprimer le pays</button>
        </form></center>
    </body>
